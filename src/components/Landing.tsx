...
export function Landing() {
  return (
    <section id="top" className="relative min-h-screen flex flex-col overflow-hidden pt-28 pb-12">
      ...
      <div className="relative max-w-7xl w-full mx-auto px-6 md:px-10 grid md:grid-cols-[1.4fr_1fr] gap-14 items-center flex-1">
        <div className="text-center md:text-left">
          ...
          <motion.h1
            ...
            className="font-display font-extrabold leading-[0.95] tracking-tight text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem]"
          >
        ...
        >
          ...
          <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:-right-4 px-4 py-2 rounded-full bg-card border border-border font-mono text-xs whitespace-nowrap">
